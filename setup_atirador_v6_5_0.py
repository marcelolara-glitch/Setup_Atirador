...
"""
=============================================================================
SETUP ATIRADOR v6.5.0 - Scanner Profissional de Criptomoedas
=============================================================================
...
Autor: Manus AI | v4.1→v6.5.0 (revisão Claude/Anthropic)
=============================================================================
...
def fetch_perpetuals():
    ...
    LOG.info("📡 [v6.5.0] Iniciando busca de tickers — hierarquia OKX → Gate.io → Bitget")
...
async def run_scan_async():
    ...
    LOG.info("🚀 Setup Atirador v6.5.0 | Arquitetura 3 Camadas (LONG+SHORT) | Iniciando scan...")
    t_start = time.time()
    ...
    async with aiohttp.ClientSession() as session:
        ...
        report  = f"{'='*58}\n"
        report += f"🎯 SETUP ATIRADOR v6.5.0\n"
        report += f"📅 {ts_full}\n"
        ...
        report += f"💼 GESTÃO DE RISCO — Sizing Risk-First [v6.5.0]\n"
        ...
        LOG.info(report)
        LOG.info(f"✅ Scan v6.5.0 concluído em {elapsed:.1f}s | Fonte: {DATA_SOURCE} | "
