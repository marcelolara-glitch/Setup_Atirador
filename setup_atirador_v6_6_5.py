...
async def run_scan_async():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        if all_top:
            ...
            for d in top_full_long:
                ...
                if trade:
                    ...
                    results.append(d)
                    # [v6.6.5] Ponto 5 — CALL LONG: registrar evento e abrir trade no journal
            ...
            for d in top_full_short:
                ...
                # [v6.6.5] Ponto 5 — add_token SHORT (antes de qualquer filtragem de OI/trade)
                if _round_logger and sc >= 0:
                    try:
                ...
                if trade:
                    ...
                    # [v6.6.5] Ponto 5 — CALL SHORT: registrar evento e abrir trade no journal
        ...
        report  = f"{'='*58}\n"
        report += f"🎯 SETUP ATIRADOR v6.6.5\n"
        report += f"📅 {ts_full}\n"
