...
"""
=============================================================================
SETUP ATIRADOR v4.8 - Scanner Profissional de Criptomoedas
=============================================================================
...
v4.8 — Correções de consistência, nomenclatura e lógica de mercado:
  [FIX 1]  Nome do arquivo de log: atirador_LOG_YYYYMMDD_HHMM.log
           (sufixo _LOG adicionado para identificação imediata)
  [FIX 2]  Nome do relatório resumido: atirador_SCAN_YYYYMMDD_HHMM.txt
           (mesmo padrão de data/hora do log — rastreabilidade cruzada)
  [FIX 3]  Timestamp do log corrigido para BRT (antes ficava em UTC)
           Logger usa converter customizado com datetime.now(BRT)
  [FIX 4]  FGI ≤ 20 agora classifica como CAUTELOSO independente do BTC
           (FGI=11 não pode ser MODERADO — Medo Extremo é sempre Bear)
  [FIX 5]  Risk Score: FGI ≤ 20 não contribui positivamente (+0 em vez de +2)
           Medo Extremo não é sinal de entrada — é sinal de cautela
  [FIX 6]  Tokens sem dados TV (val=None) recebem flag data_missing=True
           e são excluídos do pipeline com log explicativo
           (NEUTRAL real ≠ NEUTRAL por ausência de dados)
  [FIX 7]  Relatório inclui linha: "Tokens sem dados TV: N (lista)"
           Transparência sobre o que foi descartado por falta de dados
  [FIX 8]  APT com STRONG_BUY 4H+1H investigado: score 0 no parcial
           corrigido — Bollinger posição calculada com BB_upper/BB_lower
           ausentes gerava divisão com valores zerados → score 0 forçado

v4.7: Sistema de log robusto, cache anti-corrupção, gates com logs por token
v4.6: Relatório completo, threshold oportunidades, gate SELL corrigido
...
Autor: Manus AI | v4.1→v4.8 (revisão Claude/Anthropic)
=============================================================================
"""
