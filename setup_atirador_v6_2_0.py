...
"""
=============================================================================
SETUP ATIRADOR v6.2.0 - Scanner Profissional de Criptomoedas
=============================================================================
...
Autor: Manus AI | v4.1→v6.2.0 (revisão Claude/Anthropic)
=============================================================================
...
def _tg_relatorio_rodada(ctx: dict, total_items: int, qualificados: int,
    ...
    sem_tv = f"\n   ⚠️ Sem dados TV: {', '.join(tokens_sem_dados[:5])}" if tokens_sem_dados else ""

    msg = (
        f"🤖 <b>Atirador v6.2.0</b> | {ts}\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"🌡️ <b>MERCADO</b>\n"
        ...
        f"  LONG:  Gate4H={n_long_gate1} → Gate1H={n_long_gate2} → Analisados={len(results)}\n"
        f"  SHORT: Gate4H={n_short_gate1} → Gate1H={n_short_gate2} → Analisados={len(results_short)}\n"
        f"  📡 Fonte: {fonte} | ⏱️ {elapsed:.1f}s{sem_tv}\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n"
    )
...
def tg_notify(ctx: dict, results: list, results_short: list,
    ...
    """
    [v6.2.0] Orquestra notificações Telegram ao final de cada scan.
...
def fetch_perpetuals():
    """
    [v6.2.0] Busca perpetuals USDT — hierarquia OKX → Gate.io → Bitget.
    ...
    LOG.info("📡 [v6.2.0] Iniciando busca de tickers — hierarquia OKX → Gate.io → Bitget")
...
async def run_scan_async():
    ...
    LOG.info("🚀 Setup Atirador v6.2.0 | Arquitetura 3 Camadas (LONG+SHORT) | Iniciando scan...")
    t_start = time.time()
    ...
    async with aiohttp.ClientSession() as session:
        ...
        report  = f"{'='*58}\n"
        report += f"🎯 SETUP ATIRADOR v6.2.0\n"
        report += f"📅 {ts_full}\n"
        ...
        LOG.info(report)
        LOG.info(f"✅ Scan v6.2.0 concluído em {elapsed:.1f}s | Fonte: {DATA_SOURCE} | "
