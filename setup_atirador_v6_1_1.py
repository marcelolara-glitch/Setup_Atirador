...
"""
=============================================================================
SETUP ATIRADOR v6.1.1 - Scanner Profissional de Criptomoedas
=============================================================================
...
v6.1 — Notificações Telegram (webhook) com dois modos de mensagem:

  [v6.1 — TELEGRAM WEBHOOK]
...
Autor: Manus AI | v4.1→v6.1.1 (revisão Claude/Anthropic)
=============================================================================
...
--- WEBHOOK WHATSAPP [ALTERNATIVA AO TELEGRAM] [PENDENTE] ---
  ...
  Decisão atual: Telegram implementado (v6.1). WhatsApp como alternativa
...
def _tg_heartbeat(ctx: dict, total_items: int, n_long_gate1: int, n_long_gate2: int,
    ...
    # [v6.1.1] Detectar duplicatas (mesmo token em LONG e SHORT — não deveria ocorrer
...
def tg_notify(ctx: dict, results: list, results_short: list,
    ...
    """
    [v6.1] Orquestra todas as notificações Telegram ao final do scan.
...
async def run_scan_async():
    ...
    LOG.info("🚀 Setup Atirador v6.1.1 | Arquitetura 3 Camadas (LONG+SHORT) | Iniciando scan...")
    t_start = time.time()
    ...
    async with aiohttp.ClientSession() as session:
        ...
        report  = f"{'='*58}\n"
        report += f"🎯 SETUP ATIRADOR v6.1.1\n"
        report += f"📅 {ts_full}\n"
        ...
        # [v6.1] Notificações Telegram — calls + heartbeat
        ...
        LOG.info(report)
        LOG.info(f"✅ Scan v6.1.1 concluído em {elapsed:.1f}s | Fonte: {DATA_SOURCE} | "
