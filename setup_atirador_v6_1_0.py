...
"""
=============================================================================
SETUP ATIRADOR v6.1 - Scanner Profissional de Criptomoedas
=============================================================================
...
Autor: Manus AI | v4.1→v6.1 (revisão Claude/Anthropic)
=============================================================================
...
# ===========================================================================
# CONFIGURAÇÃO TELEGRAM [v6.1]
# ===========================================================================
# Deixe vazios para desativar sem alterar código.
# Como obter:
#   TELEGRAM_TOKEN:   BotFather no Telegram → /newbot → copie o token
#   TELEGRAM_CHAT_ID: envie /start para o bot, depois acesse:
#                     https://api.telegram.org/bot{TOKEN}/getUpdates
#                     e copie o "id" do campo "chat"
#
# Dois modos de mensagem (ver docstring do módulo para detalhes):
#   ALERTA DE CALL  — enviado apenas quando score ≥ threshold
#   HEARTBEAT       — enviado a TODA execução (monitoramento e consistência)
#
TELEGRAM_TOKEN   = ""   # ex: "7123456789:AAFxyz..."
...
async def run_scan_async():
    ...
    LOG.info("🚀 Setup Atirador v6.1 | Arquitetura 3 Camadas (LONG+SHORT) | Iniciando scan...")
    t_start = time.time()
    ...
    async with aiohttp.ClientSession() as session:
        ...
        LOG.info(report)
        LOG.info(f"✅ Scan v6.1 concluído em {elapsed:.1f}s | Fonte: {DATA_SOURCE} | "
