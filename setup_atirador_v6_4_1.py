...
"""
=============================================================================
SETUP ATIRADOR v6.4.1 - Scanner Profissional de Criptomoedas
=============================================================================
...
v6.4.1: FIX BB/ATR zerados — separar COLS_15M em dois requests independentes
        FIX OKX OI — usar endpoint /public/open-interest com campo oiUsd real
...
def _tg_relatorio_rodada(ctx: dict, total_items: int, qualificados: int,
                          ...
                          obs_long: list = None, obs_short: list = None) -> str:
    """
...
def fetch_perpetuals():
    ...
    LOG.info("📡 [v6.4.1] Iniciando busca de tickers — hierarquia OKX → Gate.io → Bitget")
...
async def run_scan_async():
    ...
    LOG.info("🚀 Setup Atirador v6.4.1 | Arquitetura 3 Camadas (LONG+SHORT) | Iniciando scan...")
    t_start = time.time()
    ...
    async with aiohttp.ClientSession() as session:
        ...
        report  = f"{'='*58}\n"
        report += f"🎯 SETUP ATIRADOR v6.4.1\n"
        report += f"📅 {ts_full}\n"
        ...
        LOG.info(report)
        LOG.info(f"✅ Scan v6.4.1 concluído em {elapsed:.1f}s | Fonte: {DATA_SOURCE} | "
